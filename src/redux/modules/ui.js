...
// ACTION TYPES
export const CLOSE_SIDEBAR = 'citrus/ui/CLOSE_SIDEBAR'
export const OPEN_SIDEBAR = 'citrus/ui/OPEN_SIDEBAR'

export const START_LOADING = 'citrus/ui/START_LOADING'
export const STOP_LOADING = 'citrus/ui/STOP_LOADING'
